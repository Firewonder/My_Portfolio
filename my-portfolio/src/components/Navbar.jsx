...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center px-4 h-10 sm:h-20 w-full text-white bg-black fixed'>
      <div>
      <h1 className='text-3xl sm:text-5xl font-signature ml-2'>Adarsh</h1>
      </div>
